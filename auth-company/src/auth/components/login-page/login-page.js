...
export const LoginPage = () => {
    ...
    return ( <
            ...
            variant = "h5" >
            Login Page <
            /Typography> { isFetching && < CircularProgress data-testid ="loading-indicator" / >
        } <
    ...
    variant = "outlined"
    margin = "normal"
    required fullWidth helperText = { emailValidationMessage }
    ...
    variant = "outlined"
    margin = "normal"
    required fullWidth helperText = { passwordValidationMessage }
    onChange = { handleChange }
